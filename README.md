...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-swiftclient-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-swiftclient-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-swiftclient
# for installing globally
pixi global install python-swiftclient
```
...
It is possible to list all of the versions of `python-swiftclient` available on your platform:
...
```
pixi search python-swiftclient --channel conda-forge
```
